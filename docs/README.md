...
Version 2 Product Completion        COMPLETE
        ↓
Version 2 Complete                  SUSPENDED — Pending Runtime Engine Completion
        ↓
...
| Version 2 Complete           | **SUSPENDED** — Pending Runtime Engine Completion. Tag `v2.0.1` preserved. Not a rollback. Scores live in [audit v2](./project/product-readiness-audit-v2.md). | [Canonical Status](./project/product-completion-status.md) · [Hold](./project/version-2-certification-hold.md) · [Audit](./project/runtime-completion-audit.md) · [Final Certification](./project/version-2-final-certification.md) (snapshot)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| Version 3                    | **Must not begin.** Runtime Engine is still Version 2 scope.                                                                                                   | [Canonical Status](./project/product-completion-status.md) · [Hold](./project/version-2-certification-hold.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| Version 2 (paper-first) | **SUSPENDED** — architecture `v2.0.0` · product `v2.0.1` preserved · Runtime Engine incomplete |
| Release Status          | Production Ready (V1) · Version 2 paper-first certification **held**                           |
| Last Certification      | PASS then **SUSPENDED** (`v2.0.1`) — [hold](./project/version-2-certification-hold.md)         |
...
- V2 Freeze Preconditions (**Approved**): [`project/v2-freeze-preconditions.md`](./project/v2-freeze-preconditions.md)
  ...
  - Version 2 Product Completion (**COMPLETE**; certification **SUSPENDED** pending Runtime Engine review): [`project/product-completion-status.md`](./project/product-completion-status.md) · [`project/version-2-certification-hold.md`](./project/version-2-certification-hold.md) · [`project/runtime-completion-audit.md`](./project/runtime-completion-audit.md) · [`project/runtime-sequence-diagram.md`](./project/runtime-sequence-diagram.md) (canonical runtime) · [`project/runtime-engine-implementation-report.md`](./project/runtime-engine-implementation-report.md) · [`project/version-2-final-certification.md`](./project/version-2-final-certification.md) (snapshot) · charter [`project/v2-product-completion-program.md`](./project/v2-product-completion-program.md)
...
1. Version 2 certification is **SUSPENDED**. Runtime Engine implementation is submitted for architectural review. Version 3 must not begin. Status: [canonical status](./project/product-completion-status.md) · [hold](./project/version-2-certification-hold.md) · [sequence](./project/runtime-sequence-diagram.md).
...
Phase: [Canonical Product Completion Status](./project/product-completion-status.md) — Version 2 Architecture Complete · Version 2 Product Completion COMPLETE · Version 2 Certification Suspended — Pending Runtime Engine Completion  
Version: 1.0.0 (stable research OS) · 2.0.0 (architecture) · 2.0.1 (paper-first product tag preserved; certification held)
