...
| Wave C     | Product Completion — Market context (PC-12, PC-08, PC-09, PC-10)       | **CLOSED**            | Not an RC                          | Cluster, Qualification, Profile, Market State products — [`wave-c-closure-report.md`](./wave-c-closure-report.md) · readiness [`product-readiness-audit-v2.md`](./product-readiness-audit-v2.md) (55% → 83%)                                             |
| V2 Product | Version 2 paper-first customer product                                 | **COMPLETE**          | Tag `v2.0.1`                       | Final Certification — [`version-2-final-certification.md`](./version-2-final-certification.md) · passport [`version-2-release-manifest.md`](./version-2-release-manifest.md)                                                                             |
