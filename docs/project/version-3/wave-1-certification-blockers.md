...
| F-07    | S05           | S05 claims Security Review PASS without its mandatory post-implementation Verification Standard worksheet, mappings, and suite evidence.                                                                                                 |
| F-08    | S06           | S06 claims Security Verification Standard PASS without its mandatory post-implementation Verification Standard worksheet and mappings.                                                                                                   |
...
| F-14    | S06           | Isolation Close evidence does not demonstrate available production HTTP/persistence composition required by its validation stance.                                                                                                       |
