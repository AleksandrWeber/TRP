...
- No Live Trading path enablement, engine clone, Exchange Connectivity Complete claim, Bybit Connected claim, or REST/WebSocket implementation from this slice.
- Fail Closed posture preserved: planned handshake and stub adapter honesty blockers documented as honest gaps rather than fake Connected surfaces.
