...
W5-N26-b delivers **durable persistence** for Decision Evaluation anchors on `notification-delivery`. Customer-visible functionality: **None**. Survives process termination: **Yes**. Automatic restart recovery: **No** (W5-N26-c).
