...
| **W5-N29-c** | Notification Retry Scheduling Decision Projection Publication Consumption Restart Recovery Foundation       | **IMPLEMENTED** (local) — awaiting Product Owner Review |
...
| W5-N29-c                      | **IMPLEMENTED** (local) — awaiting Product Owner Review |
| W5-N29-d…e                    | **Not opened**                                          |
...
4. **Owns:** W5-N29-a inventory; W5-N29-b durable anchors; W5-N29-c restart recovery hydrate; later slices not opened.
