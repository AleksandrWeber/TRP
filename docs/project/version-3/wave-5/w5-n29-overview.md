...
| **W5-N29-b** | Notification Retry Scheduling Decision Projection Publication Consumption Persistence Foundation            | **IMPLEMENTED** (local) — awaiting Product Owner Review |
...
| W5-N29-a                      | **SYNCHRONIZED** / CLOSED                               |
| W5-N29-b                      | **IMPLEMENTED** (local) — awaiting Product Owner Review |
| W5-N29-c…e                    | **Not opened**                                          |
...
4. **Owns:** W5-N29-a inventory (synchronized); W5-N29-b durable consumption anchors (persistence only); later slices not opened.
