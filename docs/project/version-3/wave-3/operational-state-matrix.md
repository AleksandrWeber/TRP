...
| notification-delivery | Yes               | Recovering → Ready \| Unavailable                                      | Notification analytical surfaces when Ready                                                     | Independent of other durable analytical owners for continuity     | Investigate snapshot if Unavailable                                    | _(none)_                                             | Continues when other owners Unavailable. Queue durability is W3-O02 (out of scope). |
...
This matrix does **not** authorize Monitoring (W3-O05), Business Continuity, High Availability, Disaster Recovery, failover, alerting, or infrastructure orchestration.
