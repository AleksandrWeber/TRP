...
Last updated: 2026-07-18 (RC-16 M1 Mini Validation)

Living register of known technical debt. Reviewed at RC-15.1 closeout after Validation Sprint V1 (VS001–VS004); TD-028…TD-033 added from Validation Sprint findings. TD-035 updated after M1 Epic E6 (US149 Prisma drivers validated; Nest runtime wiring remains).
...
| TD-035 | Durable Event Delivery                    | Partial (M1 E6) | Outbox/Inbox/dispatcher + Prisma models/drivers/migration validated (US128–US130, US149). `EventProcessingModule` still defaults to InMemory at Nest runtime; continuous poller remains in-process `OutboxDispatcher`. Wire Prisma providers into Nest for M2 and keep Event Bus process-local for activity logs. | RC-16 M2                                    |
...
| TD-038 | Live Market Nest Outbox Wiring            | Planned         | M1 Mini Validation recommendation: switch `EventProcessingModule` from InMemory to Prisma Outbox/Inbox/ConsumerCheckpoint repositories without changing ADR-013 contracts.                                                                                                                                        | RC-16 M2                                    |
...
- TD-035 — Durable Event Delivery (Prisma drivers validated; Nest wiring partial → TD-038)
...
- TD-035 — Durable Event Delivery (Nest Prisma wiring + continuous poller)
