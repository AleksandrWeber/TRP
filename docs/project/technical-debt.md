...
| TD-034 | Stage-1 Production Path Consolidation     | Planned         | Current manual `ProductionService.tick` remains a live parallel path beside the completed M2 canonical Order → Risk → Execution → accounting path. ADR-012/015/017 require consolidating or disabling Stage-1 before M3 strategy execution.                                                                                         | RC-16 M3 entry gate                         |
