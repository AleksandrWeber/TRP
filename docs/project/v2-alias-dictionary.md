...
| **Telegram / alerts**     | **Notification Delivery** (channel adapters; Telegram first)                    | Ops delivery          | Deliver completed reports and ops alerts to humans                                                        | Trading commands; pause/resume/stop; control plane; report generation; business decisions                               |
| **Notification settings** | **User notification preferences** (Notification Delivery)                       | Ops delivery          | Enable channels, per-type routing, quiet hours                                                            | Runtime or Library configuration; SoT mutation                                                                          |
...
| Telegram bot / control | Forbidden as trading control plane. Use **Notification Delivery** for alerts only.                          |
