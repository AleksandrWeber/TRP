...
import { Breadcrumbs, PageActions } from '../../shared/product-ui';
...
export function CommandCenterTopBar({ onRefresh, refreshing = false }: Props) {
  return (
    <div className="flex flex-wrap items-end justify-between gap-4" data-testid="cc-top-bar">
      <div>
        <Breadcrumbs productId="command-center" />
        <p className="mt-2 text-xs uppercase tracking-[0.2em] text-slate-500">Operations</p>
        ...
        <PageActions productId="command-center" />
      </div>
