...
describe('OperationalContinuityView', () => {
  ...
  it('shows Notification Platform Integration operational state within platform readiness only', () => {
    const html = renderToStaticMarkup(<OperationalContinuityView readiness={ready} />);
    expect(html).toContain('Notification Platform Integration');
    expect(html).toContain('Notification Platform Integration operational state');
    expect(html).toContain('Canonical anchors');
  ...
  it('shows Notification Platform Delivery operational state within platform readiness only', () => {
    const html = renderToStaticMarkup(<OperationalContinuityView readiness={ready} />);
    expect(html).toContain('Notification Platform Delivery');
    expect(html).toContain('Notification Platform Delivery operational state');
    expect(html).toContain('Canonical anchors');
    expect(html).not.toContain('Delivering');
    expect(html).not.toContain('Implemented');
    expect(html).not.toContain('Cross-channel');
  ...
  it('shows Notification Platform Dispatch operational state within platform readiness only', () => {
    const html = renderToStaticMarkup(<OperationalContinuityView readiness={ready} />);
    expect(html).toContain('Notification Platform Dispatch');
    expect(html).toContain('Notification Platform Dispatch operational state');
    expect(html).toContain('Canonical anchors');
  ...
  it('shows Notification Platform Queue operational state within platform readiness only', () => {
    const html = renderToStaticMarkup(<OperationalContinuityView readiness={ready} />);
    expect(html).toContain('Notification Platform Queue');
    expect(html).toContain('Notification Platform Queue operational state');
    expect(html).toContain('Canonical anchors');
    expect(html).not.toContain('Queueing');
    expect(html).not.toContain('Implemented');
    expect(html).not.toContain('Cross-channel');
  });

  it('shows Notification Platform Workers operational state within platform readiness only', () => {
    const html = renderToStaticMarkup(<OperationalContinuityView readiness={ready} />);
    expect(html).toContain('Notification Platform Workers');
    expect(html).toContain('Notification Platform Workers operational state');
    expect(html).toContain('Canonical anchors');
  ...
  it('shows Notification Platform Worker Execution operational state within platform readiness only', () => {
    const html = renderToStaticMarkup(<OperationalContinuityView readiness={ready} />);
  ...
  it('shows Notification Platform Scheduler operational state within platform readiness only', () => {
    const html = renderToStaticMarkup(<OperationalContinuityView readiness={ready} />);
  ...
  it('shows Notification Platform Dead Letter operational state within platform readiness only', () => {
    const html = renderToStaticMarkup(<OperationalContinuityView readiness={ready} />);
  ...
  it('shows Notification Platform Metrics operational state within platform readiness only', () => {
    const html = renderToStaticMarkup(<OperationalContinuityView readiness={ready} />);
    expect(html).toContain('Notification Platform Metrics');
