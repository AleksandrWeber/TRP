...
export type OperationalContinuityReadinessView = {
  ...
  /** W5-N04-d — Push Notification operational continuity. */
  ...
  /** W5-N07-d — Notification Platform Dispatch operational continuity. */
  notificationPlatformDispatch: NotificationPlatformDispatchContinuityView | null;
  /** W5-N08-d — Notification Platform Queue operational continuity. */
  notificationPlatformQueue: NotificationPlatformQueueContinuityView | null;
  /** W5-N09-d — Notification Platform Workers operational continuity. */
  ...
  /** W5-N12-d — Notification Platform Scheduler operational continuity. */
  notificationPlatformScheduler: NotificationPlatformSchedulerContinuityView | null;
  /** W5-N13-d — Notification Platform Retry operational continuity. */
  notificationPlatformRetry: NotificationPlatformRetryContinuityView | null;
  /** W5-N14-d — Notification Platform Dead Letter operational continuity. */
  notificationPlatformDeadLetter: NotificationPlatformDeadLetterContinuityView | null;
  /** W5-N15-d — Notification Platform Telemetry operational continuity. */
  ...
  /** W5-N19-d — Notification Platform Retry Scheduling operational continuity. */
  notificationPlatformRetryScheduling: NotificationPlatformRetrySchedulingContinuityView | null;
  /** W5-N20-d — Notification Platform Retry Policy operational continuity. */
  notificationPlatformRetryPolicy: NotificationPlatformRetryPolicyContinuityView | null;
  /** W5-N21-d — Notification Platform Retry Backoff operational continuity. */
  notificationPlatformRetryBackoff: NotificationPlatformRetryBackoffContinuityView | null;
  /** W5-N22-d — Notification Platform Retry Backoff Calculation operational continuity. */
  ...
  /** W5-N27-d — Notification Platform Retry Scheduling Decision Projection operational continuity. */
...
export type PushNotificationContinuityView = {
  operationalState: OperationalContinuityState;
  ownerReadiness: 'ready' | 'unavailable' | 'degraded';
  recoveryTimestamp: string | null;
  recoveryDurationMs: number | null;
...
export type NotificationPlatformDispatchContinuityView = {
  operationalState: OperationalContinuityState;
  ownerReadiness: 'ready' | 'unavailable' | 'degraded';
  recoveryTimestamp: string | null;
  recoveryDurationMs: number | null;
...
export type NotificationPlatformQueueContinuityView = {
  operationalState: OperationalContinuityState;
  ownerReadiness: 'ready' | 'unavailable' | 'degraded';
  recoveryTimestamp: string | null;
  recoveryDurationMs: number | null;
...
export type NotificationPlatformWorkersContinuityView = {
  operationalState: OperationalContinuityState;
  ownerReadiness: 'ready' | 'unavailable' | 'degraded';
  recoveryTimestamp: string | null;
  recoveryDurationMs: number | null;
...
export type NotificationPlatformSchedulerContinuityView = {
  operationalState: OperationalContinuityState;
  ownerReadiness: 'ready' | 'unavailable' | 'degraded';
  recoveryTimestamp: string | null;
  recoveryDurationMs: number | null;
...
export type NotificationPlatformRetryContinuityView = {
  operationalState: OperationalContinuityState;
  ownerReadiness: 'ready' | 'unavailable' | 'degraded';
  recoveryTimestamp: string | null;
  recoveryDurationMs: number | null;
...
export type NotificationPlatformDeadLetterContinuityView = {
  operationalState: OperationalContinuityState;
  ownerReadiness: 'ready' | 'unavailable' | 'degraded';
  recoveryTimestamp: string | null;
  recoveryDurationMs: number | null;
...
export type NotificationPlatformTelemetryContinuityView = {
  operationalState: OperationalContinuityState;
  ownerReadiness: 'ready' | 'unavailable' | 'degraded';
  recoveryTimestamp: string | null;
  recoveryDurationMs: number | null;
...
export type NotificationPlatformMetricsContinuityView = {
  operationalState: OperationalContinuityState;
  ownerReadiness: 'ready' | 'unavailable' | 'degraded';
  recoveryTimestamp: string | null;
  recoveryDurationMs: number | null;
...
export type NotificationPlatformRetrySchedulingContinuityView = {
  operationalState: OperationalContinuityState;
  ownerReadiness: 'ready' | 'unavailable' | 'degraded';
  recoveryTimestamp: string | null;
  recoveryDurationMs: number | null;
...
export type NotificationPlatformRetryPolicyContinuityView = {
  operationalState: OperationalContinuityState;
  ownerReadiness: 'ready' | 'unavailable' | 'degraded';
  recoveryTimestamp: string | null;
  recoveryDurationMs: number | null;
...
export type NotificationPlatformRetryBackoffContinuityView = {
  operationalState: OperationalContinuityState;
  ownerReadiness: 'ready' | 'unavailable' | 'degraded';
  recoveryTimestamp: string | null;
  recoveryDurationMs: number | null;
...
export type NotificationPlatformRetryBackoffCalculationContinuityView = {
  operationalState: OperationalContinuityState;
  ownerReadiness: 'ready' | 'unavailable' | 'degraded';
  recoveryTimestamp: string | null;
  recoveryDurationMs: number | null;
...
export type NotificationPlatformRetryEligibilityContinuityView = {
  operationalState: OperationalContinuityState;
  ownerReadiness: 'ready' | 'unavailable' | 'degraded';
  recoveryTimestamp: string | null;
  recoveryDurationMs: number | null;
...
export type NotificationPlatformRetrySchedulingDecisionProjectionContinuityView = {
  operationalState: OperationalContinuityState;
  ownerReadiness: 'ready' | 'unavailable' | 'degraded';
  recoveryTimestamp: string | null;
  recoveryDurationMs: number | null;
