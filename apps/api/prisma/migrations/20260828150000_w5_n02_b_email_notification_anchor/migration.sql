...
CREATE TABLE "workspace_email_notification_anchors" (
    ...
    CONSTRAINT "workspace_email_notification_anchors_pkey" PRIMARY KEY ("workspace_id", "notification_id")
);
