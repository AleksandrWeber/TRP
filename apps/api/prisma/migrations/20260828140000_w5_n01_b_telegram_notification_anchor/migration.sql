...
CREATE TABLE "workspace_telegram_notification_anchors" (
    ...
    CONSTRAINT "workspace_telegram_notification_anchors_pkey" PRIMARY KEY ("workspace_id", "notification_id")
);
