...
CREATE TABLE "workspace_kraken_exchange_connectivity_states" (
    "workspace_id" TEXT NOT NULL,
    "schema_version" INTEGER NOT NULL DEFAULT 1,
    "exchange_identifier" TEXT NOT NULL DEFAULT 'KRAKEN',
    ...
    CONSTRAINT "workspace_kraken_exchange_connectivity_states_pkey" PRIMARY KEY ("workspace_id")
);
