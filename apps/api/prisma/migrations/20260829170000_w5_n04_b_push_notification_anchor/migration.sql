...
CREATE TABLE "workspace_push_notification_anchors" (
    ...
    CONSTRAINT "workspace_push_notification_anchors_pkey" PRIMARY KEY ("workspace_id", "notification_id")
);
