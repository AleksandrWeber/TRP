...
import { NOTIFICATION_PLATFORM_DEAD_LETTER_ANCHOR_REPOSITORY } from './domain/notification-platform-dead-letter-anchor.repository';
...
import { PrismaNotificationPlatformDeadLetterAnchorRepository } from './persistence/prisma-notification-platform-dead-letter-anchor.repository';
...
import { NotificationPlatformRetryBackoffRestartRecoveryService } from './domain/notification-platform-retry-backoff-restart-recovery.service';
 ...
 * W5-N21-b: durable Notification Platform Retry Backoff anchor persistence on this owner only.
 * W5-N21-c: deterministic restart recovery hydrate for canonical platform retry backoff anchors on this owner only.
...
@Module({
  ...
  providers: [
    ...
    {
      provide: NOTIFICATION_PLATFORM_DEAD_LETTER_ANCHOR_REPOSITORY,
      useFactory: (prisma: PrismaService) =>
        new PrismaNotificationPlatformDeadLetterAnchorRepository(prisma),
      inject: [PrismaService],
    },
    {
      provide: NOTIFICATION_PLATFORM_TELEMETRY_ANCHOR_REPOSITORY,
      useFactory: (prisma: PrismaService) =>
        new PrismaNotificationPlatformTelemetryAnchorRepository(prisma),
      inject: [PrismaService],
    },
    {
      provide: NOTIFICATION_PLATFORM_METRICS_ANCHOR_REPOSITORY,
      useFactory: (prisma: PrismaService) =>
        new PrismaNotificationPlatformMetricsAnchorRepository(prisma),
      inject: [PrismaService],
    },
    {
      provide: NOTIFICATION_PLATFORM_RELIABILITY_ANCHOR_REPOSITORY,
      useFactory: (prisma: PrismaService) =>
    ...
    {
      provide: NOTIFICATION_PLATFORM_RETRY_SCHEDULING_ANCHOR_REPOSITORY,
      useFactory: (prisma: PrismaService) =>
    ...
    {
      provide: NOTIFICATION_PLATFORM_RETRY_BACKOFF_ANCHOR_REPOSITORY,
      useFactory: (prisma: PrismaService) =>
        new PrismaNotificationPlatformRetryBackoffAnchorRepository(prisma),
      inject: [PrismaService],
    },
    {
      provide: NOTIFICATION_PLATFORM_RETRY_BACKOFF_CALCULATION_ANCHOR_REPOSITORY,
      useFactory: (prisma: PrismaService) =>
    ...
    {
      provide: NOTIFICATION_PLATFORM_RETRY_SCHEDULING_DECISION_ANCHOR_REPOSITORY,
      useFactory: (prisma: PrismaService) =>
        new PrismaNotificationPlatformRetrySchedulingDecisionAnchorRepository(prisma),
      inject: [PrismaService],
    },
    {
      provide: NOTIFICATION_PLATFORM_RETRY_SCHEDULING_DECISION_EVALUATION_ANCHOR_REPOSITORY,
      useFactory: (prisma: PrismaService) =>
        new PrismaNotificationPlatformRetrySchedulingDecisionEvaluationAnchorRepository(prisma),
      inject: [PrismaService],
    },
    {
      provide: NOTIFICATION_PLATFORM_RETRY_SCHEDULING_DECISION_PROJECTION_ANCHOR_REPOSITORY,
      useFactory: (prisma: PrismaService) =>
    ...
    NotificationPlatformRetryExecutionRestartRecoveryService,
    ...
    NotificationPlatformRetrySchedulingDecisionPersistenceService,
    NotificationPlatformRetrySchedulingDecisionRecoveryStore,
    ...
    SlackWebhookCredentialResolver,
    ...
    {
      provide: SLACK_CHANNEL_ADAPTER,
      useExisting: ProductionSlackWebhookNotificationAdapter,
    },
    {
