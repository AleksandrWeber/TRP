...
/** W5-N08-d — Notification Platform Queue continuity fields on platform readiness. */
export type NotificationPlatformQueueContinuityView = Readonly<{
  operationalState: OperationalState;
  ownerReadiness: 'ready' | 'unavailable' | 'degraded';
  recoveryTimestamp: string | null;
  recoveryDurationMs: number | null;
...
/** W5-N10-d — Notification Platform Worker Execution continuity fields on platform readiness. */
export type NotificationPlatformWorkerExecutionContinuityView = Readonly<{
  operationalState: OperationalState;
  ownerReadiness: 'ready' | 'unavailable' | 'degraded';
  recoveryTimestamp: string | null;
  recoveryDurationMs: number | null;
...
/** W5-N11-d — Notification Platform Worker Runtime continuity fields on platform readiness. */
export type NotificationPlatformWorkerRuntimeContinuityView = Readonly<{
  operationalState: OperationalState;
  ownerReadiness: 'ready' | 'unavailable' | 'degraded';
  recoveryTimestamp: string | null;
  recoveryDurationMs: number | null;
...
/** W5-N13-d — Notification Platform Retry continuity fields on platform readiness. */
export type NotificationPlatformRetryContinuityView = Readonly<{
  operationalState: OperationalState;
  ownerReadiness: 'ready' | 'unavailable' | 'degraded';
  recoveryTimestamp: string | null;
  recoveryDurationMs: number | null;
...
/** W5-N16-d — Notification Platform Metrics continuity fields on platform readiness. */
export type NotificationPlatformMetricsContinuityView = Readonly<{
  operationalState: OperationalState;
  ownerReadiness: 'ready' | 'unavailable' | 'degraded';
  recoveryTimestamp: string | null;
  recoveryDurationMs: number | null;
...
/** W5-N20-d — Notification Platform Retry Policy operational continuity (derived). */
export type NotificationPlatformRetryPolicyContinuityView = Readonly<{
  operationalState: OperationalState;
  ownerReadiness: 'ready' | 'unavailable' | 'degraded';
  recoveryTimestamp: string | null;
  recoveryDurationMs: number | null;
...
/** W5-N21-d — Notification Platform Retry Backoff operational continuity (derived). */
export type NotificationPlatformRetryBackoffContinuityView = Readonly<{
  operationalState: OperationalState;
  ownerReadiness: 'ready' | 'unavailable' | 'degraded';
  recoveryTimestamp: string | null;
  recoveryDurationMs: number | null;
...
export type NotificationPlatformRetryBackoffCalculationContinuityView = Readonly<{
  operationalState: OperationalState;
  ownerReadiness: 'ready' | 'unavailable' | 'degraded';
  recoveryTimestamp: string | null;
  recoveryDurationMs: number | null;
...
/** W5-N25-d — Notification Platform Retry Scheduling Decision operational continuity (derived). */
export type NotificationPlatformRetrySchedulingDecisionContinuityView = Readonly<{
  operationalState: OperationalState;
  ownerReadiness: 'ready' | 'unavailable' | 'degraded';
  recoveryTimestamp: string | null;
  recoveryDurationMs: number | null;
...
export type NotificationPlatformRetrySchedulingDecisionEvaluationContinuityView = Readonly<{
  operationalState: OperationalState;
  ownerReadiness: 'ready' | 'unavailable' | 'degraded';
  recoveryTimestamp: string | null;
  recoveryDurationMs: number | null;
...
/** W5-N28-d — Notification Platform Retry Scheduling Decision Projection Publication operational continuity (derived). */
export type NotificationPlatformRetrySchedulingDecisionProjectionPublicationContinuityView =
  Readonly<{
    operationalState: OperationalState;
    ownerReadiness: 'ready' | 'unavailable' | 'degraded';
    recoveryTimestamp: string | null;
...
/** W5-N29-d — Notification Platform Retry Scheduling Decision Projection Publication Consumption operational continuity (derived). */
...
export type PlatformOperationalProjection = Readonly<{
  ...
  /** W5-N10-d — Notification Platform Worker Execution operational continuity (derived). */
...
export function buildPlatformOperationalProjection(input: {
  ...
  return Object.freeze({
    ...
    notificationPlatformRetryPolicy: input.notificationPlatformRetryPolicy ?? null,
    ...
    notificationPlatformRetrySchedulingDecisionProjectionPublication:
      input.notificationPlatformRetrySchedulingDecisionProjectionPublication ?? null,
    notificationPlatformRetrySchedulingDecisionProjectionPublicationConsumption:
      input.notificationPlatformRetrySchedulingDecisionProjectionPublicationConsumption ?? null,
  });
}
