...
describe('OperationalContinuityController', () => {
  const projection: PlatformOperationalProjection = Object.freeze({
    ...
    notificationPlatformDispatch: null,
    notificationPlatformQueue: null,
    notificationPlatformWorkers: null,
    ...
    notificationPlatformReliability: null,
    notificationPlatformRetryExecution: null,
    notificationPlatformRetryScheduling: null,
    ...
    notificationPlatformRetrySchedulingDecision: null,
    notificationPlatformRetrySchedulingDecisionEvaluation: null,
    notificationPlatformRetrySchedulingDecisionProjection: null,
    notificationPlatformRetrySchedulingDecisionProjectionPublication: null,
    notificationPlatformRetrySchedulingDecisionProjectionPublicationConsumption: null,
  });
