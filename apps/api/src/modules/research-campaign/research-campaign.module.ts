...
@Module({
  ...
  providers: [ResearchCampaignService, CampaignReportService, MultiDatasetCampaignService],
  exports: [ResearchCampaignService, CampaignReportService, MultiDatasetCampaignService],
})
