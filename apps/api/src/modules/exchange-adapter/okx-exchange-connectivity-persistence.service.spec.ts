...
function createRepository(): OkxExchangeConnectivityStateRepository & {
  saved: DurableOkxExchangeConnectivityState[];
} {
  const saved: DurableOkxExchangeConnectivityState[] = [];
  let current: DurableOkxExchangeConnectivityState | null = null;
  return {
    saved,
    ...
    loadOkxExchangeConnectivityState: vi.fn(async () => current),
