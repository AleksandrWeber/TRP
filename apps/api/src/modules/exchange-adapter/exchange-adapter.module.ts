...
import { KRAKEN_EXCHANGE_CONNECTIVITY_STATE_REPOSITORY } from './domain/kraken-exchange-connectivity-state.repository';
...
@Module({
  ...
  providers: [
    ...
    {
      provide: KRAKEN_EXCHANGE_CONNECTIVITY_STATE_REPOSITORY,
      useFactory: (prisma: PrismaService) =>
