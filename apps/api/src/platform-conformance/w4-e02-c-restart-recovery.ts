/**
 * W4-E02-c — Bybit Exchange Connectivity Restart Recovery Foundation registry.
 *
 * Normal process restart recovery for W4-E02-b durable state on exchange-adapter owner.
...
export const W4_E02_C_SLICE_ID = 'W4-E02-c' as const;

export const W4_E02_C_EXCHANGE_CONNECTIVITY_OWNER = 'exchange-adapter' as const;

export const W4_E02_C_RECOVERED_ARTIFACT_IDS = Object.freeze([
  'persist-bybit-connection-continuity',
] as const);

export const W4_E02_C_ARCHITECTURE_CLAIMS = Object.freeze({
  ...
  bybitExchangeConnectivityStateRestoredAfterRestart: true,
...
export const W4_E02_C_EXPLICIT_OUT = Object.freeze([
...
export const W4_E02_C_TECHNICAL_DEBT_DELTA = Object.freeze({
  resolved: Object.freeze([
    'W4-E02 restart recovery foundation — durable Bybit exchange connectivity state restores after normal process restart',
  ] as const),
...
export const W4_E02_C_TRANSITION_MATRIX = Object.freeze({
