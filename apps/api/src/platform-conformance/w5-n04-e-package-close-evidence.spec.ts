...
describe('W5-N04-e package close evidence — integration / planning', () => {
  ...
  it('required close evidence reports exist', () => {
    ...
    expect(existsSync(join(WAVE5, 'w5-n04-product-owner-close-record.md'))).toBe(true);
  });
  ...
  it('status docs: W5-N04 CLOSED by Product Owner; Wave 5 COMPLETE not claimed', () => {
    ...
    const poClose = readWave5('w5-n04-product-owner-close-record.md');
    const finalIntegration = readWave5('w5-n04-final-integration-verification.md');
    ...
    expect(progress).toMatch(
      /Awaiting Product Owner instruction for W5-N05 Planning Package|W5-N05 Planning Package/i,
    );
