...
export type W3O01AInventoryRow = Readonly<{
  ...
  restartSurvivability: 'does-not-survive-today' | 'restored-after-normal-restart' | 'n/a-derived';
  currentRisk: string;
...
export const W3_O01_A_ANALYTICAL_INVENTORY: readonly W3O01AInventoryRow[] = Object.freeze([
  Object.freeze({
    ...
    restartSurvivability: 'restored-after-normal-restart',
    currentRisk: 'Report definitions disappear after API restart',
    futureSlice: 'W3-O01-d',
