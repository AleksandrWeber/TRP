...
export const W5_N05_A_NOTIFICATION_PLATFORM_INTEGRATION_INVENTORY: readonly W5N05AInventoryRow[] =
  Object.freeze([
    ...
    Object.freeze({
      ...
      capabilityCategory: 'not-implemented' as const,
      currentStatus:
        'Missing — no prisma-notification-platform-integration repository; planned W5-N05-b',
      honestyRequirement: 'Anchor persistence on notification-delivery owner only at W5-N05-b',
      futureW5N05Responsibility: 'W5-N05-b' as const,
    ...
    Object.freeze({
      artifactId: 'missing-durable-platform-integration-anchors',
      artifact: 'Durable platform integration anchors — workspace-scoped persistence',
      kind: 'persistence-candidate' as const,
      owner: 'notification-delivery' as const,
      durabilityClass: 'EPHEMERAL' as const,
      capabilityCategory: 'not-implemented' as const,
      currentStatus: 'Missing — no integration anchor table or repository; W5-N05-b',
      honestyRequirement: 'Anchor persistence must not invent SoT in slice a',
      futureW5N05Responsibility: 'W5-N05-b' as const,
      evidencePath: 'docs/project/version-3/wave-5/w5-n05-planning-summary.md',
      existsToday: false,
      authorizesPlatformIntegrationFunctional: false,
...
export const W5_N05_A_BINDING_FINDINGS = Object.freeze({
  ...
  platformIntegrationAnchorsMissing: true,
...
export const W5_N05_A_HONEST_PRODUCT_BASELINE = Object.freeze({
  ...
  notYetImplementedCapabilities: Object.freeze([
    ...
    'Durable platform integration anchors',
