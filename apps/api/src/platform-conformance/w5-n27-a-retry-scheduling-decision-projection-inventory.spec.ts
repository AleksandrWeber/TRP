...
describe('W5-N27-a notification retry scheduling decision projection inventory — unit', () => {
  ...
  it('honesty: no row authorizes eligibility functional; slice a open with missing foundations', () => {
    ...
    expect(W5_N27_A_BINDING_FINDINGS.projectionPersistenceMissing).toBe(true);
  ...
  it('persistence, recovery, and continuity gaps remain open after inventory; unified view remains open', () => {
    expect(
