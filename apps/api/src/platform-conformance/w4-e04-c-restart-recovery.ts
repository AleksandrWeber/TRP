/**
 * W4-E04-c — Kraken Exchange Connectivity Restart Recovery Foundation registry.
 *
 * Normal process restart recovery for W4-E04-b durable state on exchange-adapter owner.
...
export const W4_E04_C_SLICE_ID = 'W4-E04-c' as const;

export const W4_E04_C_EXCHANGE_CONNECTIVITY_OWNER = 'exchange-adapter' as const;

export const W4_E04_C_RECOVERED_ARTIFACT_IDS = Object.freeze([
  'persist-kraken-connection-continuity',
] as const);

export const W4_E04_C_ARCHITECTURE_CLAIMS = Object.freeze({
  ...
  krakenExchangeConnectivityStateRestoredAfterRestart: true,
...
export const W4_E04_C_EXPLICIT_OUT = Object.freeze([
...
export const W4_E04_C_TECHNICAL_DEBT_DELTA = Object.freeze({
  resolved: Object.freeze([
    'W4-E04 restart recovery foundation — durable Kraken exchange connectivity state restores after normal process restart',
  ] as const),
...
export const W4_E04_C_TRANSITION_MATRIX = Object.freeze({
