...
import { SecurityValidator } from '../../../tools/release/src/validators/security-validator.js';
...
const result = await new SecurityValidator().run(config);
process.stdout.write(`Security: ${result.status}\n`);
