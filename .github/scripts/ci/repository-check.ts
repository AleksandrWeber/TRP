...
import { RepositoryValidator } from '../../../tools/release/src/validators/repository-validator.js';
...
const result = await new RepositoryValidator().run(config);
process.stdout.write(`Repository: ${result.status}\n`);
